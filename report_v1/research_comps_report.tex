...
\begin{figure}[p]
    \centering
    \subfigure[Function inferred and interpolated using Method 1]{
      \includegraphics[width=0.47\textwidth]{sim2-function-method1.png}
    }
    \subfigure[Function inferred and interpolated using Method 2]{
      \includegraphics[width=0.47\textwidth]{sim2-function-method2.png}
    }
    \subfigure[Function inferred and interpolated using Method 3 (linear)]{
      \includegraphics[width=0.47\textwidth]{sim2-function-method3linear.png}
    }
        \subfigure[Function inferred and interpolated using Method 3 (cubic)]{
      \includegraphics[width=0.47\textwidth]{sim2-function-method3cubic.png}
    }
    \caption{Inference for the function $g(.)$ using different methods; The light blue lines are samples from the posterior distribution; The red lines are posterior mean of the function; The orange lines are the posterior credible interval with 95 percent coverage rate.}
    \label{fig:sim2func}
\end{figure}
...
\begin{figure}[p]
    \centering
    \subfigure[First derivative inferred using Method 1]{
      \includegraphics[width=0.47\textwidth]{sim2-1deriv-method1.png}
    }
    \subfigure[First derivative inferred using Method 2]{
      \includegraphics[width=0.47\textwidth]{sim2-1deriv-method2.png}
    }
    \subfigure[First derivative inferred using Method 3 (linear)]{
      \includegraphics[width=0.47\textwidth]{sim2-1deriv-method3-linear.png}
    }
        \subfigure[First derivative inferred using Method 3 (cubic)]{
      \includegraphics[width=0.47\textwidth]{sim2-1deriv-method3-cubic.png}
    }
    \caption{Inference for the function $g'(.)$ using different methods; The light blue lines are samples from the posterior distribution; The red lines are posterior mean of the function; The orange lines are the posterior credible interval with 95 percent coverage rate.}
...
\begin{figure}[p]
    \centering
    \subfigure[Second derivative inferred using Method 1]{
      \includegraphics[width=0.47\textwidth]{sim2-2deriv-method1.png}
    }
    \subfigure[Second derivative inferred using Method 2]{
      \includegraphics[width=0.47\textwidth]{sim2-2deriv-method2.png}
    }
    \subfigure[Second derivative inferred using Method 3 (linear)]{
      \includegraphics[width=0.47\textwidth]{sim2-2deriv-method3-linear.png}
    }
        \subfigure[Second derivative inferred using Method 3 (cubic)]{
      \includegraphics[width=0.47\textwidth]{sim2-2deriv-method3-cubic.png}
    }
    \caption{Inference for the function $g''(.)$ using different methods; The light blue lines are samples from the posterior distribution; The red lines are posterior mean of the function.}
...
\begin{figure}[p]
    \centering
    \subfigure[Second order difference inferred using Method 1]{
      \includegraphics[width=0.47\textwidth]{sim2-diff-1.png}
    }
    \subfigure[Second order difference inferred using Method 2]{
      \includegraphics[width=0.47\textwidth]{sim2-diff-2.png}
    }
    \subfigure[Second order difference inferred using Method 3 (linear)]{
      \includegraphics[width=0.47\textwidth]{sim2-diff-3.png}
    }
