...
1. Replication study using independent samples.
2. Study the relationship between (aggregated) difference in MCI, with the nominal coverage rate.
3. Study the more complex functional/operator defined for the function $g()$.)
