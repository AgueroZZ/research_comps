...
\begin{figure}[p]
    ...
    \caption{Inference for $g,g',g''$ using different methods for simulation 1, being replicated for 1000 independent data sets.}
...
\begin{figure}[p]
    ...
    \caption{Inference for $g,g',g''$ using different methods for simulation 2, being replicated for 1000 independent data sets.}
    \label{fig:sim2-1000replic}
\end{figure}
...
\begin{figure}[p]
    \centering
    \subfigure[$g$ inferred using RW2]{
      \includegraphics[width=0.47\textwidth]{sim3-g-RW2.pdf}
    }
    \subfigure[$g$ inferred using ARIMA]{
      \includegraphics[width=0.47\textwidth]{sim3-g-ARIMA.pdf}
    }
    \subfigure[$g'$ inferred using RW2]{
      \includegraphics[width=0.47\textwidth]{sim3-g1st-RW2.pdf}
    }
     \subfigure[$g'$ inferred using ARIMA]{
      \includegraphics[width=0.47\textwidth]{sim3-g1st-ARIMA.pdf}
    }
        \subfigure[$g''$ inferred using RW2]{
      \includegraphics[width=0.47\textwidth]{sim3-g2nd-RW2.pdf}
    }
     \subfigure[$g''$ inferred using ARIMA]{
      \includegraphics[width=0.47\textwidth]{sim3-g2nd-ARIMA.pdf}
    }
...
\begin{figure}[p]
    \centering
    \subfigure[rIAE for $g$]{
      \includegraphics[width=0.29\textwidth]{sim3-g-rIAE.pdf}
    }
    \subfigure[MCI for $g$]{
      \includegraphics[width=0.29\textwidth]{sim3-g-MCI.pdf}
    }
    \subfigure[CR for $g$]{
      \includegraphics[width=0.29\textwidth]{sim3-g-CR.pdf}
    }
     \subfigure[rIAE for $g'$]{
      \includegraphics[width=0.29\textwidth]{sim3-g1st-rIAE.pdf}
    }
        \subfigure[MCI for $g'$]{
      \includegraphics[width=0.29\textwidth]{sim3-g1st-MCI.pdf}
    }
     \subfigure[CR for $g'$]{
      \includegraphics[width=0.29\textwidth]{sim3-g1st-CR.pdf}
    }
         \subfigure[rIAE for $g''$]{
      \includegraphics[width=0.29\textwidth]{sim3-g2nd-rIAE.pdf}
    }
        \subfigure[MCI for $g''$]{
      \includegraphics[width=0.29\textwidth]{sim3-g2nd-MCI.pdf}
    }
     \subfigure[CR for $g''$]{
      \includegraphics[width=0.29\textwidth]{sim3-g2nd-CR.pdf}
    }
    \caption{Inference for $g,g',g''$ using different methods for simulation 3, being replicated for 1000 independent data sets.}
    \label{fig:sim3-1000replic}
\end{figure}
    ...
    \centering
     \subfigure[Posterior for the smoothing parameter $\sigma_s$]{
      ...
      \includegraphics[width=0.39\textwidth]{1990_RW2_Hyper2.pdf}
         ...
         \subfigure[Posterior for the overall effect $f$]{
      \includegraphics[width=0.39\textwidth]{1990_RW2_f.pdf}
    }
         \subfigure[Posterior for the random effect $f_{np}$]{
      \includegraphics[width=0.39\textwidth]{1990_RW2_fnp.pdf}
    }
     \caption{Inference obtained for the CO2 dataset using second order random walk method, for observations after year 1990.}
...
\begin{figure}[p]
    \centering
         \subfigure[Posterior for $f'_{np}$ using RW2]{
      \includegraphics[width=0.39\textwidth]{2010_RW2_1st.pdf}
    }
         \subfigure[Posterior for $f'_{np}$ using ARIMA]{
      \includegraphics[width=0.39\textwidth]{2010_ARIMA_1st.pdf}
    }
         \subfigure[Posterior for $f''_{np}$ using RW2]{
      \includegraphics[width=0.39\textwidth]{2010_RW2_2nd.pdf}
    }
             \subfigure[Posterior for $f''_{np}$ using ARIMA]{
      \includegraphics[width=0.39\textwidth]{2010_ARIMA_2nd.pdf}
    }
